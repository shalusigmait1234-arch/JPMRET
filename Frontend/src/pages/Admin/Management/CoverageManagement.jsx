              ...
              {formData.features.map((feature, idx) => (
                <div key={idx} className="flex gap-2 group/feat">
                  <div className="relative flex-1">
                    ...
                    <div className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center pointer-events-none text-[#bd9143]">
                    ...
                    <input
                      ...
                      value={feature}
                      onChange={(e) =>
                        handleArrayChange(idx, e.target.value, 'features')
                      }
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 sticky top-24">
            ...
            <div className="space-y-6">
              ...
              <button
                type="submit"
                disabled={saving || uploading}
                className={`w-full flex items-center justify-center gap-3 py-4 rounded-xl transition-all shadow-xl active:scale-95 disabled:opacity-50 ${saving || uploading ? 'bg-black text-white' : 'bg-[#001e38] text-white hover:bg-[#bd9143]'
                  }`}
              >
